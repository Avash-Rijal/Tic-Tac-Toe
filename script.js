...
function myfunc_6() {
    if (flag == 1) {
        ...
        document.getElementById("b4").textContent = "0";
        document.getElementById("b4").disabled = true;
        flag = 1;
    }
}
...
function myfunc_7() {
    if (flag == 1) {
        ...
        document.getElementById("b5").textContent = "0";
        document.getElementById("b5").disabled = true;
        flag = 1;
    }
}
...
function myfunc_8() {
    if (flag == 1) {
        ...
        document.getElementById("b6").textContent = "0";
        document.getElementById("b6").disabled = true;
        flag = 1;
    }
}
...
function myfunc_9() {
    if (flag == 1) {
        ...
        document.getElementById("b7").textContent = "0";
        document.getElementById("b7").disabled = true;
        flag = 1;
    }
}
...
function myfunc_10() {
    if (flag == 1) {
        ...
        document.getElementById("b8").textContent = "0";
        document.getElementById("b8").disabled = true;
        flag = 1;
    }
}
...
function myfunc_11() {
    if (flag == 1) {
        ...
        document.getElementById("b9").textContent = "0";
        document.getElementById("b9").disabled = true;
        flag = 1;
    }
}
